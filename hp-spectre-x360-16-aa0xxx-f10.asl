DefinitionBlock ("", "SSDT", 5, "aigi  ", "x360-eu0", 0x02000000)
{
    ...
    External (_SB_.PC00.RP09.PXP_, PowerResObj)
    ...
    //
    // RP09.PXSX looks like it was initially supposed to be a storage device and wasn't updated after the port repurpose.
    ...
    //
    Name (_SB.PC00.RP09.PXSX._S0W, 3)
